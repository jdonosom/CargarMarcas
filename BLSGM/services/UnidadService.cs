...
{
#nullable disable
    public partial class UnidadService: Unidad, IUnidad
	{
		private Unidad current;
        public Unidad Current { get; }
		...
		public List<Unidad> GetAll()
		{
			...
			try
			{
				...
				DB.AsignarParametroEntero("@IdUnidad", 0);
        ...
        public Unidad Get(System.Int32 IdUnidad)
        {
            ...
            try
            {
                ...
                while (reader.Read())
                {
                    ...
                    this.IdDireccion = current.IdDireccion;
                    this.IdUnidad = current.IdUnidad;
                    this.Descripcion = current.Descripcion;
                    this.Ubicacion = current.Ubicacion;
                    this.Telefono = current.Telefono;
